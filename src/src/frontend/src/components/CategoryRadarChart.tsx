    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Visual breakdown of your productivity across categories</CardDescription>
        </CardHeader>
        <CardContent className="flex h-[300px] items-center justify-center">
          <p className="text-sm text-muted-foreground">No tasks yet. Start adding tasks to see your balance!</p>
        </CardContent>
      </Card>
    );
  }
