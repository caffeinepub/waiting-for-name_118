import { c as createLucideIcon, ac as clsx, ad as React, r as reactExports, j as jsxRuntimeExports, a5 as useTasksForDateRange, ae as TrendingUp } from "./index-CFChMxcl.js";
import { P as PremiumGate } from "./PremiumGate-9j6EQdkB.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardDescription, d as CardContent } from "./card-ER1_sDuR.js";
import { g as getAngledRectangleWidth, i as isNumber, G as Global, a as getStringSize, m as mathSign, b as isFunction, T as Text, s as shallowEqual, f as filterProps, c as get, L as Layer, d as adaptEventsOfChild, e as Label, u as useChartWidth, h as useChartHeight, j as useOffset, k as useArbitraryXAxis, l as useYAxisWithFiniteDomainOrRandom, w as warn, n as getCoordinatesOfGrid, o as getTicksOfAxis, D as Dot, p as findAllByType, E as ErrorBar, C as Curve, A as Animate, q as interpolateNumber, r as isEqual, t as isNil, v as hasClipDot, x as LabelList, y as getValueByDataKey, z as uniqueId, B as getCateCoordinateOfLine, F as useXAxisOrThrow, H as useYAxisOrThrow, I as generateCategoricalChart, J as formatAxisMap, R as ResponsiveContainer, K as Tooltip } from "./generateCategoricalChart-C53svgN5.js";
import { f as format, s as startOfWeek, e as endOfWeek, i as calculateWeeklySummary } from "./taskCalculations-B_EzMnEl.js";
import { C as Calendar } from "./calendar-BWowLZJX.js";
import "./lock-DxGoKddm.js";
/**
...
function WeeklyChart({ dailySummaries }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Weekly Performance" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Daily completion scores over the past 7 days" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 250, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: chartData, children: [
...
function WeeklyPageInner() {
  ...
  const getTrendIcon = () => {
    switch (weeklySummary.trend) {
      case "improving":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-5 w-5 text-success" });
      case "declining":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "h-5 w-5 text-destructive" });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-5 w-5 text-muted-foreground" });
    }
  };
  const getTrendColor = () => {
    switch (weeklySummary.trend) {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground", children: "Loading weekly data..." })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold tracking-tight", children: "Weekly Performance" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium text-muted-foreground", children: "Average Score" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-3xl font-bold text-primary", children: [
          weeklySummary.averageScore,
          "%"
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium text-muted-foreground", children: "Completion Rate" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-3xl font-bold text-primary", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium text-muted-foreground", children: "Trend" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-medium text-muted-foreground", children: "Active Days" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-3xl font-bold text-primary", children: [
          weeklySummary.dailySummaries.filter((d) => d.totalTasks > 0).length,
          " ",
          "/ 7"
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WeeklyChart, { dailySummaries: weeklySummary.dailySummaries }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-2", children: [
      weeklySummary.bestDay && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-success/20 bg-success/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Your highest performing day this week" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: format(new Date(weeklySummary.bestDay.date), "EEEE") }),
      ...
      weeklySummary.worstDay && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-accent/20 bg-accent/5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2 text-accent", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "h-5 w-5" }),
            "Room for Growth"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Focus area for improvement" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: format(new Date(weeklySummary.worstDay.date), "EEEE") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-sm text-muted-foreground", children: [
            "Score: ",
            weeklySummary.worstDay.score,
            "%"
          ] })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Daily Breakdown" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Detailed view of each day this week" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: weeklySummary.dailySummaries.map((day) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-center justify-between rounded-lg border border-border bg-card p-4",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-medium", children: format(new Date(day.date), "EEEE, MMM d") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-bold text-primary", children: [
              day.score,
              "%"
            ] }) })
          ]
...
function WeeklyPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PremiumGate, { featureName: "Weekly Performance", children: /* @__PURE__ */ jsxRuntimeExports.jsx(WeeklyPageInner, {}) });
}
export {
  WeeklyPage
};
