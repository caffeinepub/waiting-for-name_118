import { N as useActor, ae as useQueryClient, ap as useInternetIdentity, Q as useQuery, af as useMutation, j as jsxRuntimeExports, S as Sparkles, X as Crown, B as Button, r as reactExports, s as ue, ag as LoaderCircle } from "./index-C4UCX3Pq.js";
import { B as Badge } from "./badge-BZjDR-Mk.js";
import { C as Card, d as CardContent, a as CardHeader, b as CardTitle } from "./card-yUGtAkII.js";
import { m as motion, A as AnimatePresence } from "./proxy-CrXD28CB.js";
import { Z as Zap } from "./zap-wXiO6jDj.js";
import { S as Star } from "./star-Cb90mJga.js";
...
function WheelSpinPage() {
  ...
  const { data: activeTitle } = useQuery({
    queryKey: ["activeTitle", principal == null ? void 0 : principal.toString()],
    queryFn: async () => {
  ...
  const setActiveTitleMutation = useMutation({
    ...
    onSuccess: (_data, title) => {
      ue.success(`"${title}" is now your active title!`);
      queryClient.invalidateQueries({
        queryKey: ["activeTitle", principal == null ? void 0 : principal.toString()]
      });
    },
    onError: () => ue.error("Failed to set title")
  });
      ...
      motion.div,
      {
        ...
        children: [
          ...
          earnedTitles.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: earnedTitles.map((title) => {
              const tier = getTitleTier(title);
              const isActive = activeTitle === title;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `flex items-center justify-between gap-3 rounded-lg px-3 py-2 border transition-all ${isActive ? "border-primary/50 bg-primary/10" : "border-border/40 bg-muted/20"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                      isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-3.5 w-3.5 text-primary shrink-0" }),
                      tier === "legendary" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "span",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        onClick: () => !isActive && setActiveTitleMutation.mutate(title),
                        disabled: isActive || setActiveTitleMutation.isPending,
                        "data-ocid": "wheel.title.toggle",
                        children: isActive ? "Equipped" : "Set as Title"
                      }
                    )
                  ]
                },
