import { c as createLucideIcon, Z as React, r as reactExports, j as jsxRuntimeExports, F as cn, G as buttonVariants, B as Button$1, $ as createPopperScope, u as useControllableState, a0 as Root2$1, a as createContextScope, b as useId, f as useComposedRefs, P as Primitive, d as composeEventHandlers, a1 as Anchor, e as Presence, a2 as Portal$1, a3 as hideOthers, a4 as ReactRemoveScroll, a5 as createSlot, a6 as useFocusGuards, a7 as FocusScope, a8 as DismissableLayer, a9 as Content, aa as Arrow, N as useActor, Q as useQuery, ab as useDuplicateRoutine, ac as useDuplicateWeekRoutine, X as Crown, V as Link, ad as Copy, L as Label, s as ue, ae as useQueryClient, af as useMutation, I as Input, ag as LoaderCircle } from "./index-C4UCX3Pq.js";
import { C as ChevronLeft, a as ChevronRight } from "./chevron-right-CASvwuog.js";
import { C as ChevronDown, S as Select$1, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, P as Plus, T as Trash2 } from "./select-BGa3J2I_.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardDescription, d as CardContent } from "./card-yUGtAkII.js";
import { t as toDate$1, l as constructFrom$1, g as getTodayDateString, f as format$1, s as startOfWeek$1, e as endOfWeek$1 } from "./taskCalculations-BK5qpWMe.js";
...
function PlanTomorrowSection() {
  ...
  const addTaskMutation = useMutation({
    mutationFn: async () => {
      ...
      const priorityEnum = { [priority]: null };
    ...
    onSuccess: () => {
      ue.success("Task added for tomorrow!");
      setTaskName("");
      setCategory("work");
      setPriority("medium");
      setDuration(30);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-primary/20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { children: [
        "Pre-set tasks for ",
        format$1(addDays$1(/* @__PURE__ */ new Date(), 1), "EEEE, MMM d")
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "tomorrow-task-name", children: "Task Name" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select$1,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "routine.tomorrow.category.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select$1,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "routine.tomorrow.priority.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: PRIORITIES.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: p.value, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: p.color, children: p.label }) }, p.value)) })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "tomorrow-duration", children: "Duration (minutes)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button$1,
          {
            ...
            children: addTaskMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-semibold text-muted-foreground mb-2", children: [
          "Tomorrow's Plan",
          " ",
        ...
        tasksLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Loading tasks..." })
            ]
          }
        ) : tomorrowTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "text-center py-6 rounded-lg border border-dashed border-border/50",
            "data-ocid": "routine.tomorrow.empty_state",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "h-8 w-8 mx-auto text-muted-foreground/40 mb-2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No tasks planned yet" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "routine.tomorrow.list", children: tomorrowTasks.map((task, idx) => {
          const priorityInfo = PRIORITIES.find(
            (p) => task.priority === p.value
          );
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium truncate", children: task.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                    Math.round(Number(task.estimatedDuration) / 60),
                    " min",
                    priorityInfo && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `ml-2 ${priorityInfo.color}`, children: priorityInfo.label })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button$1,
...
function RoutinePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PlanTomorrowSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-primary/20 bg-primary/5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "•" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Plan Tomorrow:" }),
            " Manually add specific tasks you want to tackle tomorrow"
          ] })
        ] }),
